...
function Navbar() {
  ...
  return (
    <div
      className={`flex h-14 items-center justify-center border-b border-b-richblack-700 ${location.pathname !== "/" ? "bg-richblack-800" : ""
        }`}
    >
                ...
                <li key={index}>
                  {link.title === "Catalog" ? (
                    ...
                    >
                      ...
                      {/* Dropdown */}
                      <div className="invisible absolute left-1/2 top-full z-50 mt-2 w-[200px] -translate-x-1/2 rounded-lg bg-richblack-5 p-4 text-richblack-900 opacity-0 transition-all group-hover:visible group-hover:opacity-100 lg:w-[300px]">
                        {loading && (
